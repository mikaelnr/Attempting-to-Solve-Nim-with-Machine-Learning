...
class SpaceSaveQlearning:
	...
	"""This method is for training the matrix Q, by using the Q-learning algorithm. The main difference is that it removes the calculated reward, instead of adding it.
